...
def wordpress_thirteen_t4(time_of_synethic_exfil=None, only_exp_info=False, initiator_info_for_paths=None,
                            portion_for_training=None, training_window_size=None, size_of_neighbor_training_window=None,
                            synthetic_exfil_paths_train=None,
                            synthetic_exfil_paths_test=None, calc_vals=False,
                            skip_model_part=False,max_number_of_paths=None,
    ...
    basefile_name = '/Volumes/exM2/experimental_data/wordpress_info/wordpress_thirteen_t4/edgefiles/wordpress_thirteen_t4_'
    basegraph_name = '/Volumes/exM2/experimental_data/wordpress_info/wordpress_thirteen_t4/graphs/wordpress_thirteen_t4_'
    alert_file = '/Volumes/exM2/experimental_data/wordpress_info/wordpress_thirteen_t4/alerts/wordpress_thirteen_t4_'

    container_info_path = "/Volumes/exM2/experimental_data/wordpress_info/wordpress_thirteen_t4/wordpress_thirteen_t4_docker_0_network_configs.txt"
    cilium_config_path = None # does NOT use cilium on reps 2-4
    kubernetes_svc_info = '/Volumes/exM2/experimental_data/wordpress_info/wordpress_thirteen_t4/wordpress_thirteen_t4_svc_config_0.txt'
    kubernetes_pod_info = '/Volumes/exM2/experimental_data/wordpress_info/wordpress_thirteen_t4/wordpress_thirteen_t4_pod_config_0.txt'
    pcap_paths = [
        "/Volumes/exM2/experimental_data/wordpress_info/wordpress_thirteen_t4/wordpress_thirteen_t4_default_bridge_0any.pcap"]

    is_swarm = 0
    ms_s = ["my-release-pxc", "wwwppp-wordpress"]
    start_time = False
    end_time = None
    exfil_start_time = 7040
    exfil_end_time = 7040
    graph_p = False  # should I make graphs?
    colors = ['b', 'r']
    wiggle_room = 2  # the number of seconds to extend the start / end of exfil time (to account for imperfect synchronization)
    ...
    return wordpress_thirteen_t4_object
...
def wordpress_fourteen_REALDEAL(time_of_synethic_exfil=None, only_exp_info=False, initiator_info_for_paths=None,
                            portion_for_training=None, training_window_size=None, size_of_neighbor_training_window=None,
                            synthetic_exfil_paths_train=None,
                            synthetic_exfil_paths_test=None, calc_vals=False,
                            skip_model_part=False,max_number_of_paths=None,
    ...
    basefile_name = '/Volumes/exM2/experimental_data/wordpress_info/wordpress_fourteen_2_autoscaling_FORREAL_/edgefiles/wordpress_fourteen_2_autoscaling_FORREAL__'
    basegraph_name = '/Volumes/exM2/experimental_data/wordpress_info/wordpress_fourteen_2_autoscaling_FORREAL_/graphs/wordpress_fourteen_2_autoscaling_FORREAL__'
    alert_file = '/Volumes/exM2/experimental_data/wordpress_info/wordpress_fourteen_2_autoscaling_FORREAL_/alerts/wordpress_fourteen_2_autoscaling_FORREAL__'

    pod_creation_log = "/Volumes/exM2/experimental_data/wordpress_info/wordpress_fourteen_2_autoscaling_FORREAL_/wordpress_fourteen_2_autoscaling_FORREAL__pod_creation_log.txt"
    container_info_path = "/Volumes/exM2/experimental_data/wordpress_info/wordpress_fourteen_2_autoscaling_FORREAL_/wordpress_fourteen_2_autoscaling_FORREAL__docker_0_network_configs.txt"
    cilium_config_path = None # does NOT use cilium on reps 2-4
    kubernetes_svc_info = '/Volumes/exM2/experimental_data/wordpress_info/wordpress_fourteen_2_autoscaling_FORREAL_/wordpress_fourteen_2_autoscaling_FORREAL__svc_config_0.txt'
    kubernetes_pod_info = '/Volumes/exM2/experimental_data/wordpress_info/wordpress_fourteen_2_autoscaling_FORREAL_/wordpress_fourteen_2_autoscaling_FORREAL__pod_config_0.txt'
    pcap_paths = [
        "/Volumes/exM2/experimental_data/wordpress_info/wordpress_fourteen_2_autoscaling_FORREAL_/wordpress_fourteen_2_autoscaling_FORREAL__default_bridge_0any.pcap"]

    is_swarm = 0
    ms_s = ["my-release-pxc", "wwwppp-wordpress"]
    start_time = False
    end_time = None
    exfil_start_time = 3550
    exfil_end_time = 3550
    graph_p = False  # should I make graphs?
    colors = ['b', 'r']
    wiggle_room = 2  # the number of seconds to extend the start / end of exfil time (to account for imperfect synchronization)
    ...
    return wordpress_fourteen_REALDEAL_object

def wordpress_fourteen_mark7(time_of_synethic_exfil=None, only_exp_info=False, initiator_info_for_paths=None,
                            portion_for_training=None, training_window_size=None, size_of_neighbor_training_window=None,
                            synthetic_exfil_paths_train=None,
                            synthetic_exfil_paths_test=None, calc_vals=False,
                            skip_model_part=False,max_number_of_paths=None,
...
def new_new_wordpress_recipe():
    ...
    ####
    cur_experiment_name = "hourTest_"  # can modify if you want, probably with:  new_wordpress_recipe.__name__
    base_output_location = '/Volumes/exM2/experimental_data/wordpress_summary/new_new_'  # + 'lasso_roc'
    ...
    experiment_classes = [wordpress_fourteen_REALDEAL(training_window_size=training_window_size,
                                                size_of_neighbor_training_window=size_of_neighbor_training_window,
                                                calc_vals=calc_vals,
                                                time_of_synethic_exfil=time_of_synethic_exfil,
    ...
    print "about to run multi_experiment_pipeline... "
    multi_experiment_pipeline(experiment_classes, base_output_location, True, time_of_synethic_exfil,
                              goal_train_test_split_training, goal_attack_NoAttack_split_training,
                              training_window_size,
...
def new_wordpress_autoscaling_recipe():
    ...
    experiment_classes = [wordpress_fourteen_mark7(training_window_size=training_window_size,
                                                size_of_neighbor_training_window=size_of_neighbor_training_window,
                                                calc_vals=calc_vals,
                                                time_of_synethic_exfil=time_of_synethic_exfil,
                                                time_interval_lengths=time_interval_lengths,
...
def new_wordpress_recipe():
    ...
    #####
    # IN MEGABYTES / MINUTE
    avg_exfil_per_min = [100000000.0] #[100.0, 10.0, 2.0, 1.0, 0.25, 0.1]
    exfil_per_min_variance = [100.0] #[1.0, 0.3, 0.2, 0.15, 0.08, 0.05]
    avg_pkt_size = [1000.0] #[500.0, 500.0, 500.0, 500.00, 500.00, 500.0]
...
if __name__=="__main__":
    ...
    if len(sys.argv) == 1:
        ...
        #new_new_wordpress_recipe() # testing autoscaling stuff...
